...
public class ShopFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
		View caiquanLayout=inflater.inflate(R.layout.shop_layout,container,false);
		...
		listViews.add(new ShopIndexFragment());
		listViews.add(new ShopMyApptFragment());
		listViews.add(new ShopCollectionFragment());
