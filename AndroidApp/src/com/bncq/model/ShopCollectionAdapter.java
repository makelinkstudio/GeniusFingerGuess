...
public class ShopCollectionAdapter extends BaseAdapter {
	...
	private static class ViewHolder{
		...
		TextView tvw_shop_integralLeft;
	...
	public ShopCollectionAdapter(Activity activity,ArrayList<HashMap<String, Object>> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if(convertView==null){
			convertView=layoutInflater.inflate(R.layout.shop_collection_listitem, null);
			...
			holder.tvw_shop_integralLeft=(TextView) convertView.findViewById(R.id.tvw_shop_integralLeft);
		...
		holder.tvw_shop_integralLeft.setText(MainApplication.getContext().getResources().getString(R.string.shop_integralLeft)+listData.get(position).get("AVD_INTEGRAL_DIFF").toString());
