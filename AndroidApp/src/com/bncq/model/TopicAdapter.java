...
public class TopicAdapter extends BaseAdapter {
	...
	public TopicAdapter(Activity activity,ArrayList<HashMap<String, Object>> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.tvw_topic_ComNum.setText(listData.get(position).get("REPLY_COUNT").toString()+MainApplication.getContext().getResources().getString(R.string.topic_comment));
		return convertView;
	}
